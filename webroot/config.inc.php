...
// vh/vw , % or px
// jpg/gif/png
$adminfilelistzoommaxwidth='87vw';
...
//$scanner='eSCL'; // Leave as-is for now soon new option
$scanner='s400w'; 
...
//defaul page size ONLY A4', 'letter', 'legal', 'AB', 'ISOB5' or 'JISB5' CASE SENSITIVE
$defaultscansize='letter';


//Python scan file location and name
$eSCL = '/var/www/html/scan.py';  
...
// path (if required) and nae of python executable
$pythoncmd = 'python';
...
// if yiu change this you need to change to edit the overrides below. They are not calculated 
$margin='0.66cm';
